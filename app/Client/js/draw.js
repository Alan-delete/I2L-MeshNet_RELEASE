...
let position = [32.5407, 31.5434, 32.0625,
...
let camera, controls, scene, renderer,skeleton, spine_vector, quaternion
...
function update_skeleton(new_position){
    ...
    spine_vector = new THREE.Vector3( new_position[chest_index*3]-new_position[Pelvis_index*3], new_position[chest_index*3+1]-new_position[Pelvis_index*3+1], new_position[chest_index*3+2]-new_position[Pelvis_index*3+2] ).normalize();
    quaternion.setFromUnitVectors( spine_vector,new THREE.Vector3( 0, 1, 0 ) );
    skeleton.applyQuaternion(quaternion);
...
function create_skelton(position){
    ...
    spine_vector = new THREE.Vector3( position[chest_index*3]-position[Pelvis_index*3], position[chest_index*3+1]-position[Pelvis_index*3+1], position[chest_index*3+2]-position[Pelvis_index*3+2] ).normalize();
    quaternion = new THREE.Quaternion();
